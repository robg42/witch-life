...
function Back() {
  return (
    <div
      className="absolute inset-0 flex items-center justify-center border border-bark/30 bg-bark text-bone shadow-md"
...
function Front({ card }: { card: Card }) {
  return (
    <div
      className="absolute inset-0 flex flex-col items-center justify-between gap-2 border border-bark/30 bg-parchment p-5 text-ink shadow-md"
      style={{
