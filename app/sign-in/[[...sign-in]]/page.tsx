...
/*
  The arrival page. Cream herbarium surface, multi-coloured botanical
  plate to the side, Clerk's SignIn embedded in light theme. This is
  what visitors see first — bright, alive, hand-illustrated — before
  crossing into the darker interior of the reading itself.
*/
  ...
  return (
    <main className="min-h-screen bg-bone text-ink">
      <div className="mx-auto grid min-h-screen max-w-6xl grid-cols-1 px-6 py-8 md:grid-cols-12 md:gap-12 md:px-12 md:py-12">
        {/* Left: brand identity + botanical plate */}
        ...
        <section className="flex flex-col justify-center md:col-span-5">
          <div className="md:max-w-md">
            ...
            <p className="oracle-body mt-4 text-ink/75">
              Sign in to find your daily reading already waiting.
              <br />
              <Link
                href="/sign-up"
